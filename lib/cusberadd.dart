...
class UserCreation123 extends StatefulWidget {
  const UserCreation123({Key? key}) : super(key: key);

  @override
  _UserCreationScreenState createState() => _UserCreationScreenState();
}

class _UserCreationScreenState extends State<UserCreation123> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        request.fields['schemeType'] = "2000";
        request.fields['schemeDate'] = "hchhschs";
