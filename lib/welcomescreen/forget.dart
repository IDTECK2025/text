...
class emailInputPopup extends StatefulWidget {
  final Function(String) onComplete;
  const emailInputPopup({super.key, required this.onComplete});

  @override
  State<emailInputPopup> createState() => _PhoneInputPopupState();
}

class _PhoneInputPopupState extends State<emailInputPopup>
  ...
  Widget _buildInputWidget() {
    return Column(
      ...
      children: [
        ...
        // Privacy text
        Text(
          'Your email number is secure with us',
          style: TextStyle(
            fontSize: 12,
